        ...
        for c,window in enumerate(range(range_st,range_end,window_size)):
            ...
            for d,container in enumerate(self.container_names):
                ...
                for x in self.metric_names:
                    ...
                    if (service_name==this_service or (service_name == "PDO" and this_service=="mysql")):
                        print(x)
                        query = 'from(bucket:"'+self.bucket+'")\
                                |> range(start: '+ str(start)+', stop: '+ str(end)+')\
...
class influx_data_client:
    def __init__(self,url,token,org):
        self.client = influxdb_client.InfluxDBClient(url,token,org,timeout=300_000)
...
metrics_new = ["rt_user_get_mongo_checkid_count" , "rt_cart_delete_redis_bucket" , "rt_cart_delete_redis_count" , "rt_cart_delete_redis_sum" , "rt_cart_get_catalogue_bucket" , "rt_cart_get_catalogue_count" , "rt_cart_get_catalogue_sum" , "rt_cart_get_redis_bucket" , "rt_cart_get_redis_count" , "rt_cart_get_redis_sum" , "rt_cart_post_redis_bucket" , "rt_cart_post_redis_count" , "rt_cart_post_redis_sum" , "rt_catalogue_get_mongo_categories_bucket" , "rt_catalogue_get_mongo_categories_count" , "rt_catalogue_get_mongo_categories_sum" , "rt_catalogue_get_mongo_products_bucket" , "rt_catalogue_get_mongo_products_count" , "rt_catalogue_get_mongo_products_sum" , "rt_catalogue_get_mongo_productscat_bucket" , "rt_catalogue_get_mongo_productscat_count" , "rt_catalogue_get_mongo_productscat_sum" , "rt_catalogue_get_mongo_productsku_bucket" , "rt_catalogue_get_mongo_productsku_count" , "rt_catalogue_get_mongo_productsku_sum" , "rt_catalogue_get_mongo_search_bucket" , "rt_catalogue_get_mongo_search_count" , "rt_catalogue_get_mongo_search_sum" , "rt_dispatch_get_rabbitmq_bucket" , "rt_dispatch_get_rabbitmq_count" , "rt_dispatch_get_rabbitmq_sum" , "rt_payment_delete_cart_bucket" , "rt_payment_delete_cart_count" , "rt_payment_delete_cart_created" , "rt_payment_delete_cart_sum" , "rt_payment_get_user_bucket" , "rt_payment_get_user_count" , "rt_payment_get_user_created" , "rt_payment_get_user_sum" , "rt_payment_post_user_bucket" , "rt_payment_post_user_count" , "rt_payment_post_user_created" , "rt_payment_post_user_sum" , "rt_shipping_get_citiescode_seconds_count" , "rt_shipping_get_citiescode_seconds_max" , "rt_shipping_get_citiescode_seconds_sum" , "rt_user_get_mongo_checkid_bucket" , "rt_user_get_mongo_checkid_sum" , "rt_user_get_mongo_history_bucket" , "rt_user_get_mongo_history_count" , "rt_user_get_mongo_history_sum" , "rt_user_get_mongo_users_bucket" , "rt_user_get_mongo_users_count" , "rt_user_get_mongo_users_sum" , "rt_user_get_redis_bucket" , "rt_user_get_redis_count" , "rt_user_get_redis_sum" , "rt_user_post_mongo_login_bucket" , "rt_user_post_mongo_login_count" , "rt_user_post_mongo_login_sum" , "rt_user_post_mongo_order_bucket" , "rt_user_post_mongo_order_count" , "rt_user_post_mongo_order_sum" , "rt_user_post_mongo_register_bucket" , "rt_user_post_mongo_register_count" , "rt_user_post_mongo_register_sum" , "rt_web_get_shipping_calcid_seconds_count" , "rt_web_get_shipping_calcid_seconds_max" , "rt_web_get_shipping_calcid_seconds_sum" , "rt_web_get_shipping_code_seconds_count" , "rt_web_get_shipping_code_seconds_max" , "rt_web_get_shipping_code_seconds_sum" , "rt_web_get_shipping_matchcode_seconds_count" , "rt_web_get_shipping_matchcode_seconds_max" , "rt_web_get_shipping_matchcode_seconds_sum" , "rt_web_get_shipping_postconfirm_seconds_count" , "rt_web_get_shipping_postconfirm_seconds_max" , "rt_web_get_shipping_postconfirm_seconds_sum" , "rt_web_post_payment_bucket" , "rt_web_post_payment_count" , "rt_web_post_payment_created" , "rt_web_post_payment_sum","rt_ratings_get_catalogue_sum","rt_ratings_get_catalogue_count","rt_ratings_put_PDO_count","rt_ratings_put_PDO_sum", "rt_web_get_ratings_sum", "rt_web_get_ratings_count"]
#etrics_new = ['rt_cart_delete_redis_bucket', 'rt_cart_get_catalogue_bucket', 'rt_cart_delete_redis_sum', 'rt_cart_delete_redis_count', 'rt_cart_get_catalogue_count', 'rt_cart_get_catalogue_sum', 'rt_cart_get_redis_bucket', 'rt_cart_get_redis_count', 'rt_cart_get_redis_sum', 'rt_cart_post_redis_bucket', 'rt_cart_post_redis_count', 'rt_cart_post_redis_sum', 'rt_dispatch_consume_rabbitmq_bucket', 'rt_dispatch_consume_rabbitmq_count', 'rt_dispatch_consume_rabbitmq_sum', 'rt_payment_post_rabbitmq_bucket', 'rt_payment_post_rabbitmq_count', 'rt_payment_post_rabbitmq_created', 'rt_payment_post_rabbitmq_sum', 'rt_user_get_mongo_checkid_bucket', 'rt_user_get_mongo_checkid_count', 'rt_user_get_mongo_checkid_sum', 'rt_user_get_mongo_history_bucket', 'rt_user_get_mongo_history_count', 'rt_user_get_mongo_history_sum', 'rt_user_get_redis_sum', 'rt_user_get_redis_count', 'rt_user_get_mongo_users_sum', 'rt_user_get_mongo_users_count', 'rt_user_get_mongo_users_bucket', 'rt_user_get_redis_bucket', 'rt_user_post_login_bucket', 'rt_user_post_login_count', 'rt_user_post_login_sum', 'rt_user_post_order_bucket', 'rt_user_post_order_count', 'rt_user_post_order_sum', 'rt_user_post_register_bucket', 'rt_user_post_register_count', 'rt_web_get_catalogue_allproduts_bucket', 'rt_web_get_catalogue_allproduts_count', 'rt_user_post_register_sum', 'rt_web_get_catalogue_categories_bucket', 'rt_web_get_catalogue_allproduts_sum', 'rt_web_get_catalogue_categories_sum', 'rt_web_get_catalogue_categories_count', 'rt_web_get_catalogue_productsfromcategories_bucket', 'rt_web_get_catalogue_productsfromcategories_count', 'rt_web_get_catalogue_productsfromcategories_sum', 'rt_web_get_catalogue_productsku_bucket', 'rt_web_get_catalogue_productsku_count', 'rt_web_get_catalogue_productsku_sum', 'rt_web_get_catalogue_search_bucket', 'rt_web_get_catalogue_search_count', 'rt_web_get_catalogue_search_sum','rt_shipping_get_citiescode_seconds_count','rt_shipping_get_citiescode_seconds_sum','rt_web_get_shipping_calcid_seconds_max','rt_web_get_shipping_calcid_seconds_count','rt_web_get_shipping_calcid_seconds_sum','rt_web_get_shipping_code_seconds_count','rt_web_get_shipping_code_seconds_max','rt_web_get_shipping_code_seconds_sum','rt_web_get_shipping_matchcode_seconds_count','rt_web_get_shipping_matchcode_seconds_max','rt_web_get_shipping_matchcode_seconds_sum','rt_web_get_shipping_postconfirm_seconds_count','rt_web_get_shipping_postconfirm_seconds_max','rt_web_get_shipping_postconfirm_seconds_sum']
...
services = ["web", "user","shipping","redis","ratings", "rabbitmq", "payment","mysql","mongo","dispatch","cart","catalogue"]
...
st_time = 1676565360+3600+3600+3600 #1676190960 
